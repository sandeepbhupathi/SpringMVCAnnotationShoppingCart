...
<body>
	...
	<form method="POST" action="${pageContext.request.contextPath}/shoppingCartConfirmation">
		...
		<a class="navi-item"
			href="${pageContext.request.contextPath}/shoppingCartCustomer">Edit Customer Info
		</a>
		...
		<c:forEach items="${myCart.cartLines}" var="cartLineInfo">
			<div class="product-preview-container">
				<ul>
					...
					<li>Code: ${cartLineInfo.productInfo.code} <input type="hidden" name="code" value="${cartLineInfo.productInfo.code}" /> </li>
